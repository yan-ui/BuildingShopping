...
public class HomePromoteGoodsRvAdapter extends BaseQuickAdapter<HomeBean.PromotionGoodsBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, HomeBean.PromotionGoodsBean item) {
