package cn.weiben.buildingshopping.ui.mine.collect
...
import cn.weiben.buildingshopping.ui.mine.collect.goods.CollectGoodsHttpRecyclerFragment
import cn.weiben.buildingshopping.ui.mine.collect.shop.CollectShopHttpRecyclerFragment
...
class MyCollectActivity : BaseActivity() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mTabNameList.add("收藏的宝贝")
        mTabNameList.add("收藏的店铺")
        mFragments.add(CollectGoodsHttpRecyclerFragment())
        mFragments.add(CollectShopHttpRecyclerFragment())
        initMagicIndicator()
