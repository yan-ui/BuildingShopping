 ...
 * @see <pre>
 *       基础使用：
 *       extends BaseHttpRecyclerMVPFragment 并在子类initView中 initSmartRefreshLayout、initRecyclerView、 srlBaseHttpRecycler.autoRefresh()
 *
 *       列表数据加载及显示过程：
 ...
 *   </pre>
 */
public abstract class BaseHttpRecyclerMVPFragment<P extends BaseContract.BasePresenter, T, VH extends BaseViewHolder, A extends BaseQuickAdapter<T, VH>>
        extends BaseRecyclerMVPFragment<P, T, VH, A>
        implements OnStopLoadListener, OnRefreshListener {

    private static final String TAG = "BaseHttpRecyclerMVPFragment";
